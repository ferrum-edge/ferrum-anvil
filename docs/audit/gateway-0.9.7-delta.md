...
|---|---|---|
| v0.9.7 (`lab/gateway/RELEASE.lock`, `lab/gateway/releases/v0.9.7.lock`) | `ferrum-edge-macos-aarch64` sha256 `f3bd0027…0dd03` | 314 passed, 0 failed, 15 skipped: core 36/0/0, policy 48/0/1, admission 8/0/2, drain 4/0/0, tls 66/0/7, auth 80/0/5, streams 62/0/0, cpdp 10/0/0 |
| v0.9.5 (`lab/gateway/releases/v0.9.5.lock`) | `ferrum-edge-macos-aarch64` sha256 `6a531f2c…ce5f` | 314 passed, 0 failed, 15 skipped: the same per-profile counts |
